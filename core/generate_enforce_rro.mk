...
enforce_rro_product_name := $(subst lineage_,infinity_,$(PRODUCT_NAME))
enforce_rro_override_module := $(subst Lineage,Infinity,$(subst lineage,infinity,$(subst lineageos,infinityx,$(enforce_rro_source_module))))
